...
{	 
	...
	$(".openmenu5").click(function(){
		$(".opensubmenu5").toggleClass("show");
		$(".openmenu5").toggleClass('special');
	});
	$(".cio-pdf").click(function(){
		$(".cio-pdf-1").addClass("show");
	});
 });
$(document).ready(function()
{	 
	$(".tablinkext").mouseover(function(){
    $(".tablinkext").removeClass("extenddiv");
		$(this).addClass("extenddiv");
	});
 }); 
 
$(document).ready(function()
{	 
	$(".howitwork_texttab").mouseover(function(){
    $(".howitwork_texttab").removeClass("howitworkdiv");
		$(this).addClass("howitworkdiv");
	});
 }); 
