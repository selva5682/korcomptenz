...
class SimplenewsPersonalizationFormsTest extends SimplenewsTestBase {
  ...
  public function testSynchronizeRegisterSubscribe() {
    ...
    $this->assertRaw(t('<span onclick="thankclose_popup()" class="error_thank_closed">×</span><div class="ff-thankyou"> <div class="jumbotron text-center animation-element slide-left"> <div class="icon-contt "><span><img src="/themes/custom/korone/images/flat-fee/thumb-icon.png" width="70"></span></div>There is an account registered for the e-mail address %mail. Please log in to manage your newsletter subscriptions</div></div>', array('%mail' => $email)));
