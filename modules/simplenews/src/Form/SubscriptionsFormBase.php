  ...
  public function validateForm(array &$form, FormStateInterface $form_state) {
    ...
    if (\Drupal::currentUser()->isAnonymous() && $user = user_load_by_mail($mail)) {
      $message = $user->isBlocked() ?
        $this->t('<style>#myModal{display:none !important;}</style><span onclick="thankclose_popup()" class="error_thank_closed">×</span><div class="ff-thankyou"> <div class="jumbotron text-center animation-element slide-left" style="background-color: #a51b00; color:#FFF;"> <div class="icon-contt "><span><img src="/themes/custom/korone/images/flat-fee/thumb-icon.png" width="70"></span></div>The email address %mail belongs to a blocked user.</div></div>', array('%mail' => $mail)) :
        $this->t('<style>#myModal{display:none !important;}</style><span onclick="thankclose_popup()" class="error_thank_closed">×</span><div class="ff-thankyou"> <div class="jumbotron text-center animation-element slide-left" style="background-color: #a51b00; color:#FFF;"> <div class="icon-contt "><span><img src="/themes/custom/korone/images/flat-fee/thumb-icon.png" width="70"></span></div>Thanks for logging in your details, this email %mail is already registered in our database. Please enjoy your reading time on this page. <br /> Thank you. </div></div>', array('%mail' => $mail));
